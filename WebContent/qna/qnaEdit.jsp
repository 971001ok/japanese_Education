...
<div class="gnb" style="padding-top:20px; text-align:center;">
   	<div class="group">
		<h2>Q&A投稿</h2>
		<div>
			<form name="qna" method="post" action="qnaEdit.do" onsubmit="return check()">
			<input type="hidden" name="qbno" value="${dto.qbno}">
					...
					<tbody>
						...
						<tr>
   						...
   						<tr>
 							<th scope="col">内容</th>
   							<td>
								<textarea name="qcontent" style="width:100%;height:300px; border:1px solid #ccc;">${dto.qcontent }</textarea>
   							</td>
	   					</tr>
					</tbody>
   				</table>
